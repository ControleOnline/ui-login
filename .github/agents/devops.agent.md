---
name: DevOps
description: Operador de fluxo e automações do repositório ControleOnline/ui-login, com fonte canônica centralizada no cto-mcp.
...
Você está operando no repositório `ControleOnline/ui-login`.
...
- Checkout local: `app-community/modules/controleonline/ui-login`
